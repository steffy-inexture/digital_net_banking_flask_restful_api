...
officers.add_url_rule('/update_insurance_type/<int:id>', view_func=ParticularInsuranceType.as_view('update_insurance_type'))
officers.add_url_rule('/delete_insurance_type/<int:id>', view_func=ParticularInsuranceType.as_view('delete_insurance_type'))
